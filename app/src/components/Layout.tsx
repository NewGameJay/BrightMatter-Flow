        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <Link to="/" className="flex items-center space-x-2">
              <div className="w-8 h-8 bg-gradient-to-r from-flow-blue to-flow-purple rounded-lg flex items-center justify-center">
                <span className="text-white font-bold text-sm">V</span>
              </div>
              <span className="text-xl font-bold text-gray-900">Veri x Flow</span>
            </Link>
              ...
              <Link
                ...
                className={`px-3 py-2 rounded-md text-sm font-medium transition-colors ${
                  isActive('/creator')
                    ...
                    : 'text-gray-700 hover:text-flow-blue hover:bg-gray-100'
                }`}
              >
                Creator
              </Link>
      ...
      <footer className="bg-white border-t border-gray-200 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Veri x Flow</h3>
              <p className="text-gray-600 text-sm">
                Building the future of creator economy with on-chain verification and automated payouts.
              </p>
            </div>
            <div>
              <h4 className="text-sm font-semibold text-gray-900 mb-4">Built with Flow</h4>
            ...
            <div>
              <h4 className="text-sm font-semibold text-gray-900 mb-4">Hackathon Project</h4>
              <p className="text-gray-600 text-sm">
